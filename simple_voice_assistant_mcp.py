...
Adds tool calling capabilities through MCP servers
"""
...
class MCPVoiceAssistant:
    def __init__(self):
        ...
        If you need to use a tool, clearly state what you're doing."""
    ...
    async def setup_mcp_connections(self):
        ...
        mcp_servers = {
            ...
            "weather": {
                "command": "python",
                "args": ["-m", "weather_mcp_server"]  # Custom weather server
            },
            "calendar": {
                "command": "python", 
                "args": ["-m", "calendar_mcp_server"]  # Custom calendar server
            }
        }
    ...
    async def generate_response_with_tools(self, user_input):
        ...
        try:
            ...
            chat_completion = self.groq_client.chat.completions.create(
                ...
                temperature=0.7,
                max_tokens=300,  # Increased for tool explanations
                stream=False
            )
    ...
    def run_conversation_loop(self):
        ...
        print("\n🚀 MCP Voice Assistant is ready! Start speaking...")
        print("💡 Try asking about files, weather, or calendar events!")
...
def main():
    """Main function to run the MCP voice assistant"""
